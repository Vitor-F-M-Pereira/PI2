...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (move_uploaded_file($anexo_tmp, $anexo_destino)) {
        ...
        echo "<script>
        alert('Nova justificativa registrada com sucesso!');
...
<center>
            <input type="time" id="horario_inicio" name="horario_inicio" required step="600"> Até
            <input type="time" id="horario_fim" name="horario_fim" required step="600">
</center>
